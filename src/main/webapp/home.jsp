                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-sm-4 mb-4">
                            <div class="phone-item">
                                ...
                                <div class="mt-2">
                                    <a href="#!" class="text-decoration-none text-dark">Iphone 13 Pro 128GB Silver</a>
                        ...
                        <div class="col-lg-3 col-sm-4 mb-4">
                            <div class="phone-item">
                                ...
                                <div class="mt-2">
                                    <a href="#!" class="text-decoration-none text-dark">Iphone 13 Pro Max 64GB Blue</a>
                        ...
                        <div class="col-lg-3 col-sm-4 mb-4">
                            <div class="phone-item">
                                ...
                                <div class="mt-2">
                                    <a href="#!" class="text-decoration-none text-dark">Iphone 13 Pro Max 64GB Gold</a>
                                    <div class="product-price text-muted">Online price: $1690</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-sm-4 mb-4 mb-lg-0">
                            <div class="phone-item">
                                ...
                                <div class="mt-2">
                                    <a href="#!" class="text-decoration-none text-dark">Iphone 13 Pro Max 64GB Graphite</a>
                        ...
                        <div class="col-lg-3 col-sm-4">
                            <div class="phone-item">
                                ...
                                <div class="mt-2">
                                    <a href="#!" class="text-decoration-none text-dark">Samsung Galaxy Z-Flip 3</a>
                        ...
                        <div class="col-lg-3 col-sm-4">
                            <div class="phone-item">
                                ...
                                <div class="mt-2">
                                    <a href="#!" class="text-decoration-none text-dark">Iphone 11 128Gb Red</a>
                        ...
                        <div class="col-lg-3 col-sm-4">
                            <div class="phone-item">
                                ...
                                <div class="mt-2">
                                    <a href="#!" class="text-decoration-none text-dark">Samsung Galaxy Note 20</a>
                        ...
                        <div class="col-lg-3 col-sm-4">
                            <div class="phone-item">
                                ...
                                <div class="mt-2">
                                    <a href="#!" class="text-decoration-none text-dark">Samsung Galaxy Z-Fold 3</a>
                                    <div class="product-price text-muted">Online price: $2000</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-sm-4">
                            <div class="phone-item">
                                ...
                                <div class="mt-2">
                                    <a href="#!" class="text-decoration-none text-dark">Samsung Galaxy A52S Mint</a>
